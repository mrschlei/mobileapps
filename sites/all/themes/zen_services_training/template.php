...
function zen_services_training_form_alter(&$form, &$form_state, $form_id) {
...
function zen_services_training_theme($existing, $type, $theme, $path){
...
function zen_services_training_preprocess_user_register(&$variables) {
  $variables['form'] = drupal_build_form('user_register_form', user_register_form(array()));
}

//to add some text to the RSS icons
function zen_services_training_feed_icon($variables) {
