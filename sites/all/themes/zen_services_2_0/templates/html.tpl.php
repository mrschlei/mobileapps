...
<head profile="<?php print $grddl_profile; ?>">
  ...
  <?php echo "<!-- TEST: ".$_SERVER['HTTP_HOST']." -->";?>
<style>
@font-face {
	font-family:'Antonio';
	font-style:normal;
	font-weight:normal;
	src:url(<?php //echo $_SERVER['HTTP_HOST']; ?>/sites/all/themes/zen_services_2_0/css/webfonts/antonio-regular-webfont.eot);
	src:url(<?php //echo $_SERVER['HTTP_HOST']; ?>/sites/all/themes/zen_services_2_0/css/webfonts/antonio-regular-webfont.eot?) format('eot'),url(<?php //echo $_SERVER['HTTP_HOST']; ?>/sites/all/themes/zen_services_2_0/css/webfonts/antonio-regular-webfont.woff) format('woff');
}
@font-face {
	font-family:'Antonio Light';
	font-style:normal;
	font-weight:normal;
	src:url(<?php //echo $_SERVER['HTTP_HOST']; ?>/sites/all/themes/zen_services_2_0/css/webfonts/antonio-light-webfont.eot);
	src:url(<?php //echo $_SERVER['HTTP_HOST']; ?>/sites/all/themes/zen_services_2_0/css/webfonts/antonio-light-webfont.eot?) format('eot'),url(<?php //echo $_SERVER['HTTP_HOST']; ?>/sites/all/themes/zen_services_2_0/css/webfonts/antonio-light-webfont.woff) format('woff');
}
</style>
  <?php print $scripts; ?>
</head>
