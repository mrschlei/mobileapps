...
<body class="<?php print $classes; ?>" <?php print $attributes;?>>
  <div id="skip-link">
    <a href="#<?php print $jump_link_target; ?>" class="element-invisible element-focusable"><?php print t('Jump to Navigation'); ?></a><!-- added by schleif 1/17/13 --><a href="#main-content" class="element-invisible element-focusable"><?php print t('Jump to Main Content'); ?></a>
  </div>
  <?php print $page_top; ?>
  <?php print $page; ?>
