	...
	$.fn.jshowoff = function(settings) {
		...
		this.each(function(i) {
			...
			function addControls() {
				$wrap.append('<p class="jshowoff-controls '+uniqueClass+'-controls"><a class="jshowoff-play '+uniqueClass+'-play" href="javascript:link()" title="Play/Pause">'+config.controlText.pause+'</a> <a class="jshowoff-next '+uniqueClass+'-next" href="javascript:link()" title="Next">'+config.controlText.next+'</a> <a class="jshowoff-prev '+uniqueClass+'-prev" href="javascript:link()" title="Previous">'+config.controlText.previous+'</a></p>');
			...
			function addSlideLinks() {
				...
				$.each(gallery, function(i, val) {
					...
					$('<a class="jshowoff-slidelink-'+i+' '+uniqueClass+'-slidelink-'+i+'" href="javascript:link()" title="Feature: '+linktext+'">'+linktext+'</a>').bind('click', {index:i}, function(e){ goToAndPause(e.data.index); return false; }).appendTo('.'+uniqueClass+'-slidelinks');
				});
			};		
